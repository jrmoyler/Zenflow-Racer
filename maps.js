...
const MAPS = [
  ...
  {id:'canopy',name:'Vital Canopy Run',theme:'Living gardens above the sea',difficulty:'Sweeping',road:0x7fb2a8,edge:0x48efff,trim:0xf1f2d7,skyTop:0x5fb0e6,skyHorizon:0xd3eefb,fog:0xbcdde8,sun:0xfff6dc,
    pickups:{rows:[0.11,0.30,0.47,0.64,0.818,0.902],arcs:[0.034,0.2,0.38,0.574,0.72,0.86]},
    control:[[20,0,0],[85,0,-10],[145,8,-45],[175,19,-95],[150,30,-150],[90,34,-145],[45,29,-115],[10,22,-150],[5,19,-215],[-55,15,-245],[-125,11,-225],[-155,8,-170],[-195,4,-120],[-180,0,-65],[-115,3,-50],[-75,10,-105],[-30,8,-100],[-19,3,-71],[-49,0,-23],[-20,0,10]]}
];
...
function selectMap(id){
  ...
  buildTrackFrames();if(typeof placePickups==='function')placePickups();buildTrackMeshes();buildEnvironment();applyMapAtmosphere();
  return true;
}
