...
const MAPS = [
  {id:'cherry',name:'Cherry Blossom Skyway',image:'assets/art/map-cherry.webp',theme:'Sanctuary in the clouds',difficulty:'Flowing',road:0x6b60b8,edge:0x70f4ff,trim:0xe4b7ef,skyTop:0x6f86d6,skyHorizon:0xf4bcd6,fog:0xb9b3e2,sun:0xffe5df},
  ...
  {id:'canopy',name:'Vital Canopy Run',image:'assets/art/map-canopy.webp',theme:'Living gardens above the sea',difficulty:'Sweeping',road:0x7fb2a8,edge:0x48efff,trim:0xf1f2d7,skyTop:0x5fb0e6,skyHorizon:0xd3eefb,fog:0xbcdde8,sun:0xfff6dc,
