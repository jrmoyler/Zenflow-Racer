...
(async()=>{
 ...
 for(const required of ['garage-preview.js','garage.js','addons.js','addon-effects.js','addon-ui.js','addon-ui.css','power-icons.js','presentation.js','presentation.css','cinematics.js','cinematics.css','fonts.css','kart-assets.js','vendor/GLTFLoader.js','surface-detail.js','item-models.js','reference-polish.css','maps.js','immersion.js','kart-materials.js','kart-clips.js','racefx.js','item-art.js','abilities.js','effects.js','postfx.js','menu.js','vendor/three.min.js'])assert.ok(resources.includes(required),`Entrypoint must load ${required}`);
 const scripts=[...index.matchAll(/<script\b[^>]*src="([^"]+)"/g)].map(m=>m[1]);
 for(const [before,after] of [['progression.js','garage-preview.js'],['garage-preview.js','garage.js'],['vendor/three.min.js','vendor/GLTFLoader.js'],['vendor/GLTFLoader.js','kart-assets.js'],['kart-assets.js','game.js'],['surface-detail.js','world.js'],['vehicles.js','item-models.js'],['item-models.js','game.js'],['maps.js','world.js'],['world.js','immersion.js'],['immersion.js','game.js'],['kart-materials.js','vehicles.js'],['kart-clips.js','vehicles.js'],['vehicles.js','racefx.js'],['racefx.js','game.js'],['vehicles.js','item-art.js'],['item-art.js','game.js'],['vendor/three.min.js','world.js'],['fallback-renderer.js','world.js'],['power-icons.js','addon-ui.js'],['power-icons.js','game.js'],['effects.js','abilities.js'],['abilities.js','addons.js'],['garage-preview.js','garage.js','addons.js','addon-effects.js'],['addon-effects.js','game.js'],['game.js','addon-ui.js'],['abilities.js','game.js'],['vehicles.js','game.js'],['vendor/anime.umd.min.js','menu.js']])assert.ok(scripts.indexOf(before)<scripts.indexOf(after),`${before} must load before ${after}`);
