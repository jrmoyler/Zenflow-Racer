...
(async()=>{
 ...
 for(const required of ['garage-preview.js','garage.js','addons.js','addon-effects.js','addon-ui.js','addon-ui.css','power-icons.js','presentation.js','presentation.css','fonts.css','kart-assets.js','vendor/GLTFLoader.js','surface-detail.js','item-models.js','reference-polish.css','maps.js','immersion.js','kart-materials.js','kart-clips.js','racefx.js','item-art.js','abilities.js','effects.js','postfx.js','menu.js','vendor/three.min.js'])assert.ok(resources.includes(required),`Entrypoint must load ${required}`);
