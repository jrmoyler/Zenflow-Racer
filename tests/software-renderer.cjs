...
console.log(`PASS software 3D: topology, rotation, instances, occlusion, near clipping, bounded pixels; actual GLB median ${durations[2].toFixed(1)} ms, ${renderer.info.render.vertices} vertices, ${renderer.info.render.triangles} raster triangles, one Canvas blit.`);
